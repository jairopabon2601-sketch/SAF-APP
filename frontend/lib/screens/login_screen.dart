...
class _Particle {
  ...
  final Color color;
  const _Particle({
    required this.x, required this.startY, required this.radius,
...
class _GridPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final p = Paint()..color = Colors.white ..strokeWidth = 0.5;
    const s = 32.0;
...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  void dispose() {
    ...
    _floatCtrl.dispose(); _particleCtrl.dispose();
                  ...
                  child: Column(
                    children: [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: const Color(0xFF6C63FF).withValues(alpha: 0.3 * _pulse.value),
                                    width: 1,
                                  ),
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xFF6C63FF).withValues(alpha: 0.55 * _pulse.value),
                      ...
                      ShaderMask(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(
                            ...
                            letterSpacing: 14, color: Colors.white, height: 1.0,
                          ),
                        ),
                      ),
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          fontSize: 13.5, color: Color(0xFFB0C4EE),
                          height: 1.5, letterSpacing: 0.3, fontWeight: FontWeight.w500,
                        ),
                      ),
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Password
                                  _field(
                                    ctrl: _passwordCtrl, label: 'Contraseña',
                                    icon: Icons.lock_outline_rounded,
                                    obscure: _obscure,
                                    suffixIcon: IconButton(
                                      icon: Icon(
                                        _obscure ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                                        color: const Color(0xFF6B7DB3), size: 20,
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Expanded(child: Text(_error!,
                                          style: const TextStyle(color: Color(0xFFFF9BAF),
